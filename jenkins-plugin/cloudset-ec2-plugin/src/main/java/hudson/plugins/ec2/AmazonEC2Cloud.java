...
public class AmazonEC2Cloud extends EC2Cloud {
	...
	public static class DescriptorImpl extends EC2Cloud.DescriptorImpl {
		...
		public FormValidation doTestConnection(
			...
			String providerCode = EC2Constant.EC2Cloud;								
			...
			resourceOptions.setEndPoint(region.ec2Endpoint.toString());
			resourceOptions.setPublicCredential(accessId);
			resourceOptions.setPrivateCredential(decryptedSecretKey);
			resourceOptions.setAccountNumber(accountId);
			resourceOptions.setKey(securityKeyFileName);
			resourceOptions.setVmLoginUserID(vmOwnerId);			
			...
			return super.doTestConnection(resourceOptions);
		}
