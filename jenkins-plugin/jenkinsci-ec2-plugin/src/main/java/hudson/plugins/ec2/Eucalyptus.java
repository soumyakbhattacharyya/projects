...
public class Eucalyptus extends EC2Cloud {
    ...
    public Eucalyptus(URL url, String accessId, String secretKey, String privateKey, String instanceCapStr, List<SlaveTemplate> templates, String accountId, String securityGroup,
    String securityKeyFileName,
    String vmOwnerId) throws IOException {
        super( EC2Constant.EUCACLOUDNAME, accessId, secretKey, privateKey, instanceCapStr, templates);
        this.url = url;
    ...
    public static class DescriptorImpl extends EC2Cloud.DescriptorImpl {
        ...
        public FormValidation doTestConnection(
        	...
        	sess.setAttribute(EC2Constant.EUCA_CLOUD_PROVIDER, "Y");        	
        	sess.removeAttribute(EC2Constant.AWS_CLOUD_PROVIDER);
        	sess.removeAttribute(EC2Constant.VMWARE_CLOUD_PROVIDER);
            return super.doTestConnection(null,accessId,secretKey,privateKey,
            		accountId,securityGroup,securityKeyFileName,vmOwnerId,projectUserID,projectID);
        }
