 ...
 */
public class CloudSetAuthenticationException extends AuthenticationException
{
    /**
     ...
     */
    public CloudSetAuthenticationException(String msg, Throwable t)
    {
        super(msg, t);
    }
     ...
     * @param msg   The error message for the exception
     */
    public CloudSetAuthenticationException(String msg)
    {
        super(msg);
    }
}
