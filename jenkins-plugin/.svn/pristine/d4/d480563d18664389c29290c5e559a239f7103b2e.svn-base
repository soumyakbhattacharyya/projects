 ...
 * @author cognizant
 */
public class CreateCommandParameters extends CommandParameters {
	...
	public boolean equals(Object obj) {
		...
		final CreateCommandParameters other = (CreateCommandParameters) obj;
	...
	public CreateCommandParameters(String workspaceAbsPath, String workspaceName, String lastPreflightTimeStampFileName) {
		this.workspaceAbsPath = workspaceAbsPath;
		this.workspaceName = workspaceName;
		this.lastPreflightTimeStampFileName = lastPreflightTimeStampFileName;
	}
