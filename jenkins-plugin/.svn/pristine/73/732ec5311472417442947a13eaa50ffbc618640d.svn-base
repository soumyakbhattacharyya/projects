...
public class CloudSetAuthorizationUserACL extends ACL {
	...
	private boolean acrossProjectJobAccessEnable;
...
//									+ permissionImplied);
	...
	public CloudSetAuthorizationUserACL(String rbacURL, String keyPath,
			String rbacPassword, String cacheTime,boolean preFlightEnabled,boolean acrossProjectJobAccessEnable) {
		super();
		...
		this.acrossProjectJobAccessEnable= acrossProjectJobAccessEnable;
	}
	...
	public boolean isAcrossProjectJobAccessEnable() {
		return acrossProjectJobAccessEnable;
	}

	public void setAcrossProjectJobAccessEnable(boolean acrossProjectJobAccessEnable) {
		this.acrossProjectJobAccessEnable = acrossProjectJobAccessEnable;
	}
