...
public class MachineDetails {
	...
	public MachineDetails getMachineDetailsFromVirtualMachineType(VirtualMachineType virtualMachineType){
		this.setPublicIPAddresses(virtualMachineType.getPublicIpAddresses());
		this.setPublicdnsName(virtualMachineType.getPublicDnsAddress());
		this.setPrivateDNSName(virtualMachineType.getPrivateDnsAddress());
		this.setVmName(virtualMachineType.getName());
		return this;
	}
